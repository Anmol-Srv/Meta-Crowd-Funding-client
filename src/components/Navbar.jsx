  ...
  return (
    ...
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        <CustomButton btnType="button" title={address ? 'Disconnect' : 'Connect'} styles={address ? 'bg-[#ef5130]' : 'bg-[#8c6dfd]'} handleClick={() => {
          if (address) disconnect()
          else connect();
        }} />
        <CustomButton btnType="button" title="Create a campaign" styles={'bg-[#800080]'} handleClick={() => {
