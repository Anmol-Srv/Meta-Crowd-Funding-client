...
const CampaignDetails = () => {
  ...
  const { donate,getDonation, contract, address } = useStateContext();
    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          ...
          <img src={state.image} alt="campaign_banner" className="w-full h-[410px] object-cover rounded-xl" />
          ...
          <div>
            ...
            <div className="mt-[20px] flex flex-col gap-4">
              {donators.length > 0 ? donators.map((item, index) => (
                <div key={`${item.donator}-${index}`} className="flex justify-between item-center gap-4">
